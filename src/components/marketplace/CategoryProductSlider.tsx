...
const CategoryProductSlider = ({ category, title, color }: CategoryProductSliderProps) => {
  ...
  const getFallbackProducts = (): Product[] => {
    const fallbacks: Record<string, Product[]> = {
      lubricants: [
        { id: "1", name: "DELSTAR SYN SAE 10W40", category: "Engine Oil", price: 900, original_price: 1160, rating: 4.8, image_url: "https://www.mapettlogistics.com/cdn/shop/files/DELSTAR_30D_MULTIGRADE_15W40_5L.jpg?v=1746752133&width=400", is_featured: true },
        { id: "2", name: "PETSAR SUPER 20W50", category: "Engine Oil", price: 350, original_price: 450, rating: 4.9, image_url: "https://www.mapettlogistics.com/cdn/shop/files/PETSAR_SUPER_MULTIGRADE_20W50_4L.jpg?v=1746752246&width=400", is_featured: true },
        { id: "3", name: "SLUSOL Hydraulic Oil", category: "Hydraulic Oil", price: 7200, original_price: 8750, rating: 4.8, image_url: "https://www.mapettlogistics.com/cdn/shop/collections/DRUM.jpg?v=1764765982&width=400", is_featured: true },
      ],
      tires: [
